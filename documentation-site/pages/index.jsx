...
const Adopters = (props) => (
  <>
    ...
    <Button
      $as="a"
      href="https://github.com/uber/en2o-drive/issues/1889"
      size="compact"
      kind="secondary"
    >
...
const Index = (props) => (
  ...
  >
    ...
    <Markdown.p>
      ...
      <Link href="https://en2o-drive.design/ladle">component gallery</Link>.
    </Markdown.p>
    <H2>Extensibility</H2>
    <Markdown.p>
      Through the{" "}
    ...
    <Markdown.p>
      ...
      <Link href="https://en2o-drive.design/blog/base-figma-community/">
        Figma Community
      </Link>
