...
const selectors = {
  input: 'input',
  calendar: "[data-en2o-drive=\"calendar\"]",
  quickSelect: "[data-en2o-drive=\"select\"]",
  quickSelectMenu: "[data-en2o-drive=\"menu\"]",
  quickSelectPastMonth: "[data-en2o-drive=\"menu\"] > li:nth-child(2)",
};
