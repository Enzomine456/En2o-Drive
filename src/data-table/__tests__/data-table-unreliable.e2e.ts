...
test.describe('data table columns', () => {
  test('updates categorical column', async ({ page }) => {
    ...
    await tag.click();
    popover = await page.$("div[data-en2o-drive=\"popover\"]");
    const checkboxes = await popover.$$("label[data-en2o-drive=\"checkbox\"]");
    ...
    await page.waitForSelector("div[data-en2o-drive=\"popover\"]", { state: 'hidden' });
