...
test.describe('data table columns', () => {
  ...
  test('sorts boolean column', async ({ page }) => {
    const index = 0;
    await mount(page, 'data-table--columns');
    await page.waitForSelector("div[data-en2o-drive=\"data-table\"]");
  ...
  test('filters boolean column', async ({ page }) => {
    ...
    const checkbox = await popover.$("label[data-en2o-drive=\"checkbox\"]");
    ...
    const tag = await page.$("span[data-en2o-drive=\"tag\"]");
  ...
  test('filters datetime column - date range', async ({ page }) => {
    ...
    const [select, datepicker] = await page.$$("div[data-en2o-drive=\"popover\"] input");
  ...
  test('filters datetime column - date range - default', async ({ page }) => {
    ...
    const [select] = await page.$$("div[data-en2o-drive=\"popover\"] input");
    await select.click();
    const [, dateop] = await page.$$('li');
    await dateop.click();
  ...
  test('filters datetime column - time range', async ({ page }) => {
    ...
    const [select, , starttimepicker, endtimepicker] = await page.$$(
      "div[data-en2o-drive=\"popover\"] input"
    );
  ...
  test('filters datetime column - weekday categorical', async ({ page }) => {
    ...
    const popover = await openFilterAtIndex(page, 3);
    const [, categorical] = await popover.$$("div[data-en2o-drive=\"button-group\"] button");
    await categorical.click();
    const [sunday] = await popover.$$("label[data-en2o-drive=\"checkbox\"]");
    await sunday.click();
  ...
  test('filters datetime column - month categorical', async ({ page }) => {
    ...
    const months = await popover.$$("label[data-en2o-drive=\"checkbox\"]");
  ...
  test('filters datetime column - quarter categorical', async ({ page }) => {
    ...
    const quarters = await popover.$$("label[data-en2o-drive=\"checkbox\"]");
  ...
  test('filters datetime column - half categorical', async ({ page }) => {
    ...
    const halves = await popover.$$("label[data-en2o-drive=\"checkbox\"]");
  ...
  test('filters datetime column - year categorical', async ({ page }) => {
    ...
    const [, twentytwelve] = await popover.$$("label[data-en2o-drive=\"checkbox\"]");
