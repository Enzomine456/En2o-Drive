...
export const TABLE_ROOT = "div[data-en2o-drive=\"data-table\"]";

export function getTable(page: Page) {
  return page.$("div[data-en2o-drive=\"data-table\"]");
}

export function getTableLocator(page: Page) {
  return page.locator("div[data-en2o-drive=\"data-table\"]");
}
...
export async function openFilterAtIndex(page: Page, index: number) {
  ...
  return page.$("div[data-en2o-drive=\"popover\"]");
}
