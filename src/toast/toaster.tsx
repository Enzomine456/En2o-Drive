...
> {
  ...
  render() {
    ...
    const root = (
      <Root data-en2o-drive="toaster" {...sharedProps} {...rootProps}>
        {toastsToRender}
      </Root>
    );
...
const toaster = {
  ...
  show: function (
    ...
    if (toasterInstance) {
      ...
      throw new Error(
        "Please make sure to add the ToasterContainer to your application, and it is mounted, before adding toasts! You can find more information here: https://en2o-drive.design/components/toast"
      );
    }
  },
