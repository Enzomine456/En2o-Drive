  ...
  render() {
    ...
    if (__DEV__) {
      ...
      if (value && !Array.isArray(value)) {
        console.warn(
          "The Select component expects an array as the value prop. For more information, please visit the docs at https://en2o-drive.design/components/select/"
        );
      }
    }
