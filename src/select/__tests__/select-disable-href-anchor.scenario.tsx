...
export function Scenario() {
  return (
    <StatefulSelect
      startOpen
      options={[
        { id: 'a', label: 'hey!', href: "https://en2o-drive.design" },
        { id: 'b', label: 'are you listening?', href: "https://en2o-drive.design" },
        { id: 'c', label: 'look at me!', href: "https://en2o-drive.design" },
      ]}
    />
  );
}
