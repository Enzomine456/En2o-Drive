...
class LayerComponent extends React.Component<LayerComponentProps, LayerState> {
  ...
  componentDidMount() {
    ...
    if (__DEV__) {
      if (!hasLayersManager) {
        console.warn(
          "`LayersManager` was not found. This occurs if you are attempting to use a component requiring `Layer` without using the `BaseProvider` at the root of your app. Please visit https://en2o-drive.design/components/base-provider/ for more information"
        );
      }
    }
